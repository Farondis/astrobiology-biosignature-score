...
\centering
\includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{mars_rocks_closeup.jpg}\\[2pt]
...
\centering
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{earth_analog.jpg}\\[1pt]
...
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.34\textheight,keepaspectratio]{mars_jezero_delta.jpg}\\[1pt]
{\tiny\color{gray} Jezero Krateri deltası --- NASA/JPL-Caltech (PIA25705)}

\vspace{1pt}
\includegraphics[width=0.70\linewidth,height=0.24\textheight,keepaspectratio]{mars_hirise_layers.jpg}\\[1pt]
